...
int enter_passcode[6];  // Array is used to compare with passcode.
int passcode[6] = {1, 2, 3, 4, 5, 6};  // Default passcode.
int new_passcode[6];  // Array of values for enter new passcode.
int count = 0;    // Numerical order of passcode.
int x = 1 ;  // variable x Cursor of LCD.
int y = 9 ;  // Variable y Cursor of LCD.
int key, check, check_old;
int False_Passcode = 3;
int Check_Mode = 0; // Check change mode or enter mode. Check_Mode = 0 => Enter mode.
